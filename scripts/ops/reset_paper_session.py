...
Usage:
    python scripts/ops/reset_paper_session.py            # dry-run, show state
    python scripts/ops/reset_paper_session.py --apply    # persist reset
    python scripts/ops/reset_paper_session.py --apply --force   # skip running check
"""
