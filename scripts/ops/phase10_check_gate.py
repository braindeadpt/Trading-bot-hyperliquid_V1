...
Usage:
    python scripts/ops/phase10_check_gate.py                 # create manifest if missing, then check
    python scripts/ops/phase10_check_gate.py --no-register    # only check; fail if manifest missing
    python scripts/ops/phase10_check_gate.py --json           # machine-readable output
