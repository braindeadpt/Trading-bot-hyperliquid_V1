...
scripts/research/hl_node_trades_rebuild.py --execute:
...
Usage:
  python scripts/ops/check_hl_s3_access.py
  python scripts/ops/check_hl_s3_access.py --bucket hl-mainnet-node-data --prefix node_trades/ --max-keys 20
  python scripts/ops/check_hl_s3_access.py --list-dates
  python scripts/ops/check_hl_s3_access.py --list-dates --around 20260710
  python scripts/ops/check_hl_s3_access.py --list-prefixes
  python scripts/ops/check_hl_s3_access.py --list-prefixes node_fills/
"""
...
def main() -> int:
    ...
    print(
        ...
        "passa o template correto ao scripts/research/hl_node_trades_rebuild.py."
    )
    return 0
