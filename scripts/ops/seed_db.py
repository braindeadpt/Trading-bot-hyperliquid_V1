...
Usage:
    python scripts/ops/seed_db.py --from-date 2025-01-01 --to-date 2025-03-01
    python scripts/ops/seed_db.py --from-date 2025-01-01 --to-date 2025-01-07 --symbols BTC,ETH
    python scripts/ops/seed_db.py --from-date 2025-01-01 --to-date 2025-01-07 --db-path data/live/bot.db
"""
