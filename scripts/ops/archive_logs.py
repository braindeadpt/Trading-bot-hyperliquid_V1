...
Usage:
    python scripts/ops/archive_logs.py                    # archive all .log files
    python scripts/ops/archive_logs.py --days 7           # archive logs older than 7 days
    python scripts/ops/archive_logs.py --restore          # list what's in archive
