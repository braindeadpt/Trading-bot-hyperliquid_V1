...
Usage:
  python scripts/ops/download_recent_fills.py
  python scripts/ops/download_recent_fills.py --date 20260715 --hour 14
  python scripts/ops/download_recent_fills.py --hours 8          (last 8 hours, spanning midnight if needed)
  python scripts/ops/download_recent_fills.py --date 20260715 --start-hour 0 --end-hour 23   (whole day)
"""
...
def main() -> int:
    ...
    if ok_paths:
        ...
        print(f"  python scripts/research/build_liquidation_map.py --from-fills {' '.join(ok_paths)} --execute")
