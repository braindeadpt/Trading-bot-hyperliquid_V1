...
Preferred (durable Top 5/10 from official HL stats leaderboard):
  python scripts/ops/refresh_top_traders.py --from-leaderboard --top-n 10

Manual seed still supported:
  python scripts/ops/refresh_top_traders.py --addresses 0xabc...,0xdef...
  python scripts/ops/refresh_top_traders.py --from-json path/to/addresses.json --top-n 10
"""
...
def main() -> int:
    ...
    payload = {
        ...
        "notes": "Seeded by scripts/ops/refresh_top_traders.py (manual)",
