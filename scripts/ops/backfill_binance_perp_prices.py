...
Usage:
  python scripts/ops/backfill_binance_perp_prices.py
  python scripts/ops/backfill_binance_perp_prices.py --from-gap
  python scripts/ops/backfill_binance_perp_prices.py --start 2026-06-29 --days 50
"""
