...
Usage:
    python scripts/ops/deduplicate_candles.py --db data/live/bot.db
    python scripts/ops/deduplicate_candles.py --db data/live/bot.db --dry-run
    python scripts/ops/deduplicate_candles.py --db data/live/bot.db --yes
"""
