...
Both gates claim to separate the bleeding trades from the surviving ones:
  ...
  * IV gate "high_iv only" (scripts/research/iv_high_only_ab_split.py): keep BOTH
    VB and VWAP only when the trailing-30d DVOL percentile > p66.
  * ADX router (scripts/research/regime_router_a_b_test.py, post-rework): keep VB in
...
Reuses (no duplication):
  * run_strategy / precompute_adx / adx_at / classify_market_regime /
    ...
    scripts/research/regime_router_a_b_test.py
  * fetch_dvol / build_iv_percentile / iv_pct_at / dvol_series_for from
    scripts/research/iv_percentile_regime_gate_test.py
  * IV_ONLY_PCT / SPECS from scripts/research/iv_high_only_ab_split.py

Usage:
  python scripts/research/iv_vs_adx_disagreement.py --start 2026-05-18 --end 2026-08-07
"""
...
from scripts.research.iv_high_only_ab_split import IV_ONLY_PCT, SPECS  # noqa: E402
...
from scripts.research.regime_router_a_b_test import (  # noqa: E402
    VB_ALLOWED_REGIMES,
