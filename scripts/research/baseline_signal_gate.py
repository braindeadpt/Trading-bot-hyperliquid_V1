...
Usage:
  ...
  python scripts/research/baseline_signal_gate.py --strategy VWAPDeviation --folds W2 --seeds 200 --gate
...
from scripts.research.baseline_signal_test import (  # noqa: E402
    FOLDS,
    OUT_DIR,
    CandleStore,
    EntrySpec,
...
from scripts.research.baseline_portfolio_scan import PRIORITY, tier_note  # noqa: E402
...
def main() -> int:
    ...
    import scripts.research.baseline_signal_gate as _self
