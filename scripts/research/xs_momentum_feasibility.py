...
Usage:
  python scripts/research/xs_momentum_feasibility.py
  python scripts/research/xs_momentum_feasibility.py --skip-download   # reuse cache
  python scripts/research/xs_momentum_feasibility.py --seeds 200
