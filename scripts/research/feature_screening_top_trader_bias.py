...
Usage:
  python scripts/research/feature_screening_top_trader_bias.py
  python scripts/research/feature_screening_top_trader_bias.py --n-boot 1000
"""
...
def write_json(
    ...
    (`scripts/research/top_trader_bias_recheck.py`) can read the verdict without
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help="machine-readable output (consumed by scripts/research/top_trader_bias_recheck.py)",
    )
    args = ap.parse_args()
