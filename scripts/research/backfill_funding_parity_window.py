...
Usage:
  python scripts/research/backfill_funding_parity_window.py
  python scripts/research/backfill_funding_parity_window.py --db-path data/live/bot_ruleset_validate.db
"""
