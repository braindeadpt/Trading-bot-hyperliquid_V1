...
Usage:
  python scripts/research/calibrate_liquidation_thresholds.py
  python scripts/research/calibrate_liquidation_thresholds.py --percentile 90 --symbols BTC,ETH,SOL,HYPE
"""
