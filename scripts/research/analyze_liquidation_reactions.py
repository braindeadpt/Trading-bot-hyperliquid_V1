...
Examples:
  python scripts/research/analyze_liquidation_reactions.py --dry-run
  python scripts/research/analyze_liquidation_reactions.py --execute \\
...
def main() -> int:
    ...
    if dry_run:
        ...
        logger.info(
            ...
            "python scripts/research/build_liquidation_map.py --from-fills <paths...> --execute "
            "--max-distance-pct 50"
        )
        return 0
