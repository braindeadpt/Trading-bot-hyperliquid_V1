...
Usage:
  python scripts/research/feature_screening_24m_structure.py
  python scripts/research/feature_screening_24m_structure.py --n-boot 200
"""
...
def write_report(
    ...
    lines.append(
        ...
        "Run: `python scripts/ops/lookahead_audit.py --paths scripts/research/feature_screening_24m_structure.py`."
    )
    path.write_text("\n".join(lines) + "\n", encoding="utf-8")
