...
Usage:
    python scripts/research/backtest_vwap_trend_vs_fade.py
    python scripts/research/backtest_vwap_trend_vs_fade.py --symbols BTC,ETH --end 2026-08-07
    python scripts/research/backtest_vwap_trend_vs_fade.py --engine full   # slow fidelity
"""
