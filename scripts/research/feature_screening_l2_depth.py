...
Measurement only. Refuses to run until ``scripts/research/l2_recording_audit.py``
reports ``ready_for_screen=True``. Does not build strategies.

Usage:
  python scripts/research/feature_screening_l2_depth.py
  python scripts/research/feature_screening_l2_depth.py --force   # override readiness (debug)
"""
...
from scripts.research.l2_recording_audit import audit_l2  # noqa: E402
