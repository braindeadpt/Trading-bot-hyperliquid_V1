...
Context: VB forensics (scripts/research/vb_regime_forensics.py) showed shorts at
...
Usage:
  python scripts/research/vb_stopout_ab.py            # both runs (~30 min)
  python scripts/research/vb_stopout_ab.py --off      # stop-out disabled (baseline)
  python scripts/research/vb_stopout_ab.py --on       # calibrated floor (2.5M)
"""
