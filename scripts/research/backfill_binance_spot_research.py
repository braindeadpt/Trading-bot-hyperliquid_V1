...
Usage:
  python scripts/research/backfill_binance_spot_research.py --months 24
  python scripts/research/backfill_binance_spot_research.py --months 18 --symbols BTC,ETH,SOL
"""
