...
Usage:
  python scripts/research/merge_ghost_research_db.py --dry-run
  python scripts/research/merge_ghost_research_db.py --confirm
  python scripts/research/merge_ghost_research_db.py --confirm --remove-source
