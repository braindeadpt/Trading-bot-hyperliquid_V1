...
from scripts.research.backtest_strategy_audit import classify_strategy, DISPLAY_NAMES
...
def main() -> None:
    ...
    lines.extend([
        ...
        "- Correr `scripts/ops/backfill_external_feeds.py` e `scripts/ops/backfill_funding.py` antes do próximo audit",
        "",
    ])
