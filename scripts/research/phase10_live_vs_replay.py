...
Usage:
    python scripts/research/phase10_live_vs_replay.py --start 2026-06-01T00:00:00Z --end 2026-06-02T00:00:00Z
    python scripts/research/phase10_live_vs_replay.py --start-ms 1748736000000 --end-ms 1748822400000
    python scripts/research/phase10_live_vs_replay.py --start ... --end ... --symbols BTC,ETH --json
