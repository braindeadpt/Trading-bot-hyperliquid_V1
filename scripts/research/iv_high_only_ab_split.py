...
The single-window IV gate A/B (`scripts/research/iv_percentile_regime_gate_test.py`)
...
Usage:
  python scripts/research/iv_high_only_ab_split.py --start 2026-05-18 --end 2026-08-07 --split-days 30
"""
