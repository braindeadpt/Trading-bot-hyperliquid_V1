...
Usage:
  python scripts/research/calibrate_liquidation_stopout_floor.py [--db PATH] [--step-sec 60]
"""
...
def render_report(
    *,
    ...
    lines += [
        ...
        "momento com `python scripts/research/calibrate_liquidation_stopout_floor.py`.",
        "",
