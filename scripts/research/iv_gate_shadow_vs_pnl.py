...
Usage:
  python scripts/research/iv_gate_shadow_vs_pnl.py [--live-db PATH] [--research-db PATH]
  python scripts/research/iv_gate_shadow_vs_pnl.py --json out.json
  python scripts/research/iv_gate_shadow_vs_pnl.py --summary   # cron: one compact line
"""
...
def build_report(
    *,
    ...
    recheck watchdog (``scripts/research/iv_gate_shadow_recheck.py``) so the join and
