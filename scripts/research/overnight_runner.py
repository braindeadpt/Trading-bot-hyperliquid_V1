...
Usage:
  ...
  python scripts/research/overnight_runner.py --family flush_fade --start 2026-05-18 --end 2026-08-07

  # VWAP per-symbol z_threshold sweep (Night 2, QUEUE.md): baseline 2.5σ vs
  # 3.0σ HYPE-only vs 3.0σ everywhere
  python scripts/research/overnight_runner.py --family vwap_thresholds --start 2026-05-18 --end 2026-09-08
  ...
  python scripts/research/overnight_runner.py --family iv_thresholds --start dvol --end dvol --symbols BTC,ETH,SOL,HYPE
  # Fixed span form (e.g. the accumulator that already ran):
  python scripts/research/overnight_runner.py --family iv_thresholds --start 2026-06-14 --end 2026-09-08 --symbols BTC,ETH,SOL,HYPE
  ...
  python scripts/research/overnight_runner.py --family hype_vwap_refine --start 2026-03-13 --end 2026-09-08 --symbols HYPE,BTC,ETH

  # Self-test: verdict + report logic only, canned results, no backtests:
  python scripts/research/overnight_runner.py --selftest
"""
...
def flush_fade_family() -> Tuple[List[str], Callable[..., Dict[str, Any]], Callable[..., Any]]:
    ...
    """
    from scripts.research.backtest_liquidation_catcher_real import (  # noqa: E402
...
def iv_thresholds_family() -> Tuple[List[str], Callable[..., Dict[str, Any]], Callable[..., Any]]:
    ...
    Imports inside this function so ``--selftest`` never pulls the strategies.
    """
    from scripts.research.iv_high_only_ab_split import SPECS  # noqa: E402
    from scripts.research.regime_router_a_b_test import ms, run_strategy  # noqa: E402
    from src.data.database import Database  # noqa: E402
