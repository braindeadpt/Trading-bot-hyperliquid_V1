...
class DataAggregator:
    ...
    def get_all_data(self, asset: str) -> Dict[str, Any]:
        ...
        # ✅ Calcular variação de OI (comparando com último valor)
        ...
        # Guardar OI atual para próxima comparação
        ...
        result = {
            ...
            'ask': md.ask,
            'oi_total': current_oi,
            'oi_change_pct': oi_change_pct,  # ✅ Agora calculado corretamente!
